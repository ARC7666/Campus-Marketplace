...
function ContactUs() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    addToast('Your message has been sent to the team. We will get back to you soon.', 'success');
    ...
    <div className="infoPage">
      ...
      <div className="infoPageLayout">
        <div className="contactHero">
          <h1>Contact Us</h1>
          <p>The campus marketplace for NIT Durgapur. For the students, by the students.</p>
        </div>
        ...
        <div className="contactSidebar">
          <div className="sidebarCard">
            ...
            <div className="contactDetail">
              ...
              <span className="value">ankitnitdgpcs@gmail.com</span>
            </div>
          </div>
